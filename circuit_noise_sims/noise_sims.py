...
### Reduced HGP from random (d_v, d_c), [n, k, d_min] classical code
    ...
    Hx1, Hx2, Hz1, Hz2, _, _, _, d = get_reduced_random_code(20, 3, 5, 6, 5)
...
### Parameters -- adjustable!
    ...
    p2 = 3e-3 # two-qubit error probability
...
### Sample CNOT circuit and decoding
    ...
    failures = num_failures_BP(code, dec, circ, [max_iter, osd_lsd_order], p2, 0.05, 0.05, shots, rounds)
